...
-- AddForeignKey
ALTER TABLE [dbo].[AffectationCours] ADD CONSTRAINT [AffectationCours_id_professeur_fkey] FOREIGN KEY ([id_professeur]) REFERENCES [dbo].[Professeur]([id]) ON DELETE NO ACTION ON UPDATE CASCADE;
