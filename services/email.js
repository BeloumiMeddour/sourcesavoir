...
const envoyerEmailValidation = async (destinataire, prenom, nom) => {
    ...
    const mailOptions = {
        from: `"ecoles3S" <${process.env.EMAIL_USER}>`,
        to: destinataire,
        subject: "✅ Votre compte ecoles3S a été validé",
        html: `
            <div style="font-family: 'Segoe UI', Tahoma, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                <div style="background: linear-gradient(135deg, #2563eb, #7c3aed); padding: 30px; border-radius: 12px 12px 0 0; text-align: center;">
                    <h1 style="color: white; margin: 0; font-size: 28px;">ecoles3S</h1>
                ...
                <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px;">
                    ...
                    <p style="color: #475569; line-height: 1.6;">
                        Bonne nouvelle ! Votre compte ecoles3S a été <strong style="color: #059669;">validé par un administrateur</strong>.
                    </p>
                    <p style="color: #475569; line-height: 1.6;">
                    ...
                    <p style="color: #94a3b8; font-size: 13px; text-align: center;">
                        Cet email a été envoyé automatiquement par ecoles3S. Merci de ne pas y répondre.
                    </p>
                </div>
            </div>
        `,
